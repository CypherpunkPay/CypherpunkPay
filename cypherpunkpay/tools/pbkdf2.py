...
class PBKDF2(object):
    ...
    # The number of iterations is *intentionally* lower to limit DoS potential by unauthenticated attacker,
    ...
    #
    # The lower number of iterations makes brute forcing hashes quicker, but we consciously accept this tradeoff:
    #   * it only matters once database leaks while DoS threat is ever-present
    ...
    #   * brute forcing is *still* pretty expensive even with iterations ~10x less than some most conservative "best practices"
    #
    # In summary, we recognize DoS resistance as more critical issue than 10x-ing brute forcing costs.
    #
    ITERATIONS = 100_000
