...
class TorHttpClient(BaseHttpClient):
    ...
    def get(self, url: str, privacy_context: str, verify=None):
        ...
        try:
            return session.get(url, headers=self.TOR_BROWSER_HEADERS, timeout=BaseHttpClient.DEFAULT_TIMEOUT, verify=verify)
